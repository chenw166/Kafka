...
public class AccessServiceImpl extends AccessService
{
    ...
    /**
     * DMS api gateway signature
     *
     * @param url                The full URL of DMS request
     ...
     * Make a request that can be sent by the HTTP client.
     *
     * @param url           specifies the DMS access path.
     * @param header        specifies the header information to be added.
     * @param content       specifies the body content to be sent in the DMS call.
